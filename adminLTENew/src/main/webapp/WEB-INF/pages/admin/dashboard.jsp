      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview"><a href="dashboardpage">
            <i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
            <li><a href="usersjsp"><i class="fa fa-user"></i> <span>Users</span></a></li>
            <li><a href="operatorspage"><i class="fa fa-retweet"></i> <span>Operators</span></a></li>
          ...
          <div class="row">
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                ...
                <a href="pages/pdf/selenium-testing-syllabus-jbk.pdf" class="small-box-footer" target="_blank">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-green">
                ...
                <a href="pages/pdf/java-j2ee-syllabus-jbk.pdf" class="small-box-footer" target="_blank">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-yellow">
                ...
                <a href="pages/pdf/python-syllabus.pdf" class="small-box-footer" target="_blank">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
