<!DOCTYPE html>
<%@page import="com.jbk.hibernate.Download"%>
<%@page import="com.jbk.hibernate.Operators"%>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<%
				ArrayList<Download> dwList = (ArrayList<Download>) request.getAttribute("dwnlist");
			%>
        <!-- Main content -->
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <%
							...
							for (Download name:dwList) {
													
					%>
                    <tr>
                      <td><% out.println(name.getSr()); %></td>
                      <td><img src="pages/images/jdk.png" alt="JBK Download" style="height: 40px; padding-left: 7px;"></td>  
                      <td><% out.println(name.getName()); %></td>
                      <td><span class="label label-info"><% out.println(name.getVendor()); %></span></td>
                      <td><a href="../downloads/jdk-8u45-windows-i586.exe" download>
                        <span class="label label-success"><% out.println(name.getBit32()); %></span>
                      </a></td>
                      <td><a href="../downloads/jdk-8u211-windows-x64.exe" download >
                        <span class="label label-success"><% out.println(name.getBit64()); %></span>
                      </a></td>
                      <td><% out.println(name.getCommon()); %></td>
                      <td><a href="https://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html" target="_blank">
                        <span class="label label-warning"><% out.println(name.getOfficialSource()); %></span>
                      </a></td>
                    </tr>
                    <tr>    
								<%
