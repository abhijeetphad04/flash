...
<%@page import="com.jbk.hibernate.Statetable"%>
...
<%
				ArrayList<Statetable> stateList = (ArrayList<Statetable>) request.getAttribute("stat");
			%>
        <!-- Main content -->
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                <form  action="addUsers" method="post" class="form-horizontal" onsubmit="alert('User Added Successfully.')"> 
                  <div class="box-body">
                      ...
                      <div class="col-sm-4">
                        <select required class="form-control" name="state">
                          <option value="">--Select State--</option>
                           <%
								for (Statetable name:stateList) {
							%>
                          <option value="<% out.println(name.getLid()); %>"><% out.println(name.getState()); %></option>
                            <%
								}
							%> 
