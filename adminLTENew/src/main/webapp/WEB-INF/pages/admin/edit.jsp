...
<html>
  <head>
    ...
    <title>JavaByKiran | Edit User</title>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Edit Below Details</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" action="update" onsubmit="alert('User Updated Successfully.')"> 
       			 <div class="box-body">
                    <div class="form-group">
                      <label for="inputPassword3" class="col-sm-3 control-label">ID</label>
                      <div class="col-sm-4">
                        <input class="form-control" required id="id" value='${userdet.id}'  placeholder="ID" type="text" name="id" readonly>
                      </div>
                    </div> 
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" required id="username" value='${userdet.username}' placeholder="Username" type="text" name="username">
                      </div>
                    </div>                    
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-3 control-label">Mobile</label>
                      <div class="col-sm-4">
                        <input class="form-control" required id="mobile" value='${userdet.mobile}' placeholder="Mobile" type="number" name="mobile">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-3 control-label">Email</label>
                      <div class="col-sm-4">
                        <input class="form-control" required id="email" value='${userdet.email}' placeholder="Email" type="email" name="email">
                      </div>
                    </div>
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" required id="course" value='${userdet.course}' placeholder="Java/J2EE" type="text" name="course">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" required id="state" value='${userdet.state}' placeholder="State" type="text" name="state">
                      </div>
                    </div>                    
                    <div class="form-group">
                      <label for="inputPassword3" class="col-sm-3 control-label">Password</label>
                      <div class="col-sm-4">
                        <input class="form-control" required id="password" value='${userdet.password}' placeholder="Password" type="password" name="password">
                      </div>
                    </div>
                  ...
                  <div class="box-footer">
                    ...
                    <a href="users.html"><span class="btn btn-default pull-right" style="width:150px;">Cancel</span></a>                   
                  </div><!-- /.box-footer -->
                </form>
              </div><!-- /.box -->
